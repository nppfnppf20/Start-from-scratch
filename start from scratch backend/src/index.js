...
const programmeEventRoutes = require('./routes/programmeEvents'); // *** ADD IMPORT ***
...
// +++ Use ProgrammeEvent routes +++
app.use('/api/programme-events', programmeEventRoutes); // *** ADD USAGE ***
