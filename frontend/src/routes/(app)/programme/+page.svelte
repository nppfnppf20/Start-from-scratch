                ...
                <td class="sticky-col data-cell surveyor-name">
                    <div style="font-weight: bold; font-size: 0.9em; margin-bottom: 2px; display: flex; align-items: center;">
                      ...
                      {#if log && log.operationalNotes && log.operationalNotes.trim() !== ''}
                        <svg on:click={() => openHoldUpNotesDisplayModal(log.operationalNotes || '', quote.organisation)} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="orange" viewBox="0 0 16 16" class="hold-up-icon" style="display: inline-block; vertical-align: middle; margin-left: 5px; cursor: pointer;">
                          <title>Hold Up: {log.operationalNotes}</title>
